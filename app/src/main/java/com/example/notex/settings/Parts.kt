...
import com.example.notex.settings.theme.LocalExtraColors
...
@Composable
fun Settingsitem(icon: ImageVector, name:String, onTap:() ->Unit, contentDescription:String) {
    val iconSize=25.dp
        ...
        Row(
           ...
           Row (
               ...
               verticalAlignment = Alignment.CenterVertically
                ...
                Icon(
                    imageVector = Icons.Filled.Person, // Replace with your image
